...
#-#############################################
# Funcion de para el envio de correo electronico desde el sitio

function enviar_correo($titulo,$msg,$para,$subject)
  	{
		
	 $de ='info@rebajashn.com';// <<=== Cuenta de correo del sitio
	...
	//Get txtMessage from htmlMessage
	$txtMessage = strip_tags(str_replace("<br/>", "\n", str_replace("<br>", "\n", $htmlMessage)));
    ...
    $headers .= "Return-Path: Some One <someone@mydomain.com>\r\n"; 
    $headers .= "From: Rebajashn.com\r\n"; 
    $headers .= "Organization: rebajashn.com\r\n"; */
	...
	$message .= "<body style=\"font-family:Arial, Verdana, Geneva, sans-serif; font-size:12px;background-color: #eeeeee;\">\n"; 
		   ...
		   <tr>
			  <td align='center'>
				 ...
				 <table width='600' border='0' cellspacing='0' cellpadding='0' style='background-color: #ffffff;'>
					<tr>
					   <td align='left' style='background-color: #eeeeee;padding: 10px 20px 10px 20px;'>
						  <p>Est&agrave; recibiendo este correo pues usted se ha registrado en nuestro sitio.</p>
						  
					   </td>
					</tr>
					<tr>
					   <td class='header' align='left'>
						  <a href='http://www.rebajashn.com'> <img  src='".WEB."img/header.gif' alt='' width='600' height='150' /></a>
					   </td>
					</tr>
					<tr>
						  ...
						  <table width='100%' border='0' cellspacing='0' cellpadding='0'>
							 <tr>
							   <td width='370' valign='top' class='mainbar' align='left'>
								   <h2> $titulo </h2>
								   <img class='hr'  src='".WEB."img/hr.gif' alt='' width='340' height='3' />
							   ...
							   <td valign='top' width='170' class='sidebar' align='left'>
								   <h3>Siguenos en:</h3>
								   <br/>
								   <img src='".WEB."img/email_social.png' usemap='#Map'  />
								   <map name='Map'>
									  <area shape='rect' coords='4,1,56,48' href='http://www.facebook.com'>
									  <area shape='rect' coords='77,2,126,50' href='http://www.twitter.com'>
									</map>
							 ...
							 <tr>
							   <td colspan='3' align='left' valign='top' class='mainbar'><h2><a href='#'>&nbsp;</a></h2>
								 <img class='hr' src='".WEB."img/hr.gif' alt='' width='340' height='3' />
								 <p> <em>'Toda la información y los adjuntos en este mensaje es confidencial y privilegiada. Solamente los destinatarios están autorizados para usar esta información. Las transmisiones de correos electrónicos no están garantizadas y no son seguras o libres de errores y la empresa no acepta responsabilidad por error u omisiones. La empresa no acepta ninguna responsabilidad con respecto a cualquier comunicación que haya sido emitida incumpliendo nuestra política de e-mail.'</em></p>
							   <p></p></td>
							 </tr>
						  </table>
					   </td>
					...
					<tr>
					   <td valign='middle' align='left' height='61' style='background-color: #999999;color:#fff;font-weight: normal;font-size:12px;';>
						  <p>REBAJASHN, Todos los Derechos Reservados.</p>
					   </td>
					</tr>
				 </table>
