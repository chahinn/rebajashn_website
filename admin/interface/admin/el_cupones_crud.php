...
*/		##  *** set CSS class for datagrid
 ...
 <div id='headerhome' >
	  ...
	  <ul id='service'>
		<li><a href='el_cupones_crud.php'>Control de Ofertas</a></li>
	  </ul>
 </div>
  <br/>
  <div id='breadcrumb'>
       <a class='home' href='el_cupones_crud.php'>Inicio</a>
 ...
 $dgrid->setCaption($dg_caption);
	...
	"ciudad1"=>array("header"=>"Ciudad", "type"=>"label", "align"=>"left", "width"=>"X%|Xpx", "wrap"=>"wrap|nowrap", "text_length"=>"-1", "tooltip"=>"false", "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower|camel", "summarize"=>"false", "sort_type"=>"string|numeric", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
	"ciudad2"=>array("header"=>"Ciudad", "type"=>"label", "align"=>"left", "width"=>"X%|Xpx", "wrap"=>"wrap|nowrap", "text_length"=>"-1", "tooltip"=>"false", "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower|camel", "summarize"=>"false", "sort_type"=>"string|numeric", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
            ...
            "direccion"  =>array("header"=>"Ubicacion", "type"=>"textarea",   "req_type"=>"sy", "width"=>"500px", "title"=>"", "readonly"=>"false", "maxlength"=>"1024", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "edit_type"=>"wysiwyg", "resizable"=>"false", "rows"=>"10", "cols"=>"50"),
         	...
         	"desde"  =>array("header"=>"Disponible desde", "type"=>"datetime",   "req_type"=>"st", "width"=>"187px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "calendar_type"=>"dropdownlist"),
            "hasta"  =>array("header"=>"Disponible hasta", "type"=>"datetime",   "req_type"=>"st", "width"=>"187px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "calendar_type"=>"dropdownlist"),
		   ...
		   "ofertadiadesde"  =>array("header"=>"Oferta dia desde", "type"=>"datetime",   "req_type"=>"st", "width"=>"187px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "calendar_type"=>"dropdownlist"),
           "ofertadiahasta"  =>array("header"=>"Oferta dia hasta", "type"=>"datetime",   "req_type"=>"st", "width"=>"187px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "calendar_type"=>"dropdownlist"),
...
//		  "enlace_publicitario"=>array("header"=>"Sitio web", "type"=>"text", "align"=>"left", "width"=>"X%|Xpx", "wrap"=>"wrap|nowrap", "text_length"=>"-1", "tooltip"=>"false", "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower|camel", "summarize"=>"false", "sort_type"=>"string|numeric", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),					 
            ...
            "esevento" =>array("header"=>"Es evento", "type"=>"enum","req_type"=>"rt", "width"=>"210px", "title"=>"", "readonly"=>false, "maxlength"=>"-1", 	"default"=>"no", "unique"=>false, "unique_condition"=>"", "on_js_event"=>"", "source"=>"self", "view_type"=>"dropdownlist"),
 	 ...
 	 "ciudad1"=>array("table"=>"el_area", "field_key"=>"id_area", "field_name"=>"ciudad", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"habilitada='si'", "order_by_field"=>"id_area", "order_type"=>"ASC", "on_js_event"=>""),
         
 	 "ciudad2"=>array("table"=>"el_area", "field_key"=>"id_area", "field_name"=>"ciudad", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"habilitada='si'", "order_by_field"=>"id_area", "order_type"=>"ASC", "on_js_event"=>""),
