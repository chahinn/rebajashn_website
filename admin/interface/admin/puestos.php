...
//ver el nivel de acceso en caso de ser adicional o principal
    $ad = isset($_GET['ad']) ? $_GET['ad'] : "0";
    $dere = isset($_GET['dere']) ? $_GET['dere'] : ""; 
...
##  *** put a primary key on the first place 
  $sql ="SELECT * from members_puesto";
...
{
$modes = array(
     "add"	=>array("view"=>true, "edit"=>true, "type"=>"link"),
	...
	if(strstr($dere,'C')) {$C=true;}else{$C=false;};  
	if(strstr($dere,'R')) {$R=true;}else{$R=false;};  
	if(strstr($dere,'U')) {$U=true;}else{$U=false;};  
	if(strstr($dere,'D')) {$D=true;}else{$D=false;};  
 $modes = array(
     "add"	=>array("view"=>$C, "edit"=>$C, "type"=>"link"),
     "edit"	=>array("view"=>$R, "edit"=>true,  "type"=>"link", "byFieldValue"=>""),
     "cancel"   =>array("view"=>true, "edit"=>true,  "type"=>"link"),
     "details"  =>array("view"=>$U, "edit"=>false, "type"=>"link"),
     "delete"   =>array("view"=>$D, "edit"=>false,  "type"=>"image")
 	);
...
##  *** set DataGrid caption
 ...
 <div id='headerhome' >
	  ...
	  <ul id='service'>
		<li><a href='puestos.php'>Control de Puestos</a></li>
	  </ul>
 </div>
  <br/>
  <div id='breadcrumb'>
       <a class='home' href='puestos.php'>Inicio</a>
  </div>
    ";
...
$fill_from_array = array("0"=>"No", "1"=>"Yes");  /* as "value"=>"option" */
 $filtering_fields = array(
     "Puesto en Español"=>array("table"=>"members_puesto", "field"=>"epuesto", "source"=>"self", "show_operator"=>false, "default_operator"=>"like%", "order"=>"ASC", "type"=>"textbox", "case_sensitive"=>false, "comparison_type"=>"string"),
     "Puesto en Ingles"=>array("table"=>"members_puesto", "field"=>"ipuesto", "source"=>"self", "show_operator"=>false, "default_operator"=>"like%", "order"=>"ASC", "type"=>"textbox", "case_sensitive"=>false, "comparison_type"=>"string"),
		"Área"=>array("table"=>"members_puesto", "field"=>"area", "source"=>"self", "show_operator"=>false, "default_operator"=>"like%", "order"=>"ASC", "type"=>"textbox", "case_sensitive"=>false, "comparison_type"=>"string"),
...
##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
 $vm_colimns = array(
    "epuesto" =>array("header"=>"Puesto Espanol", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
    "ipuesto" =>array("header"=>"Puesto Ingles", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
 "area" =>array("header"=>"Area", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
 );
...
##  *** make sure your WYSIWYG dir has 777 permissions
 ...
 $fill_from_array_chargers = array("C"=>"Adicionar", "R"=>"Lectura", "U"=>"Actualizar", "D"=>"Eliminar");

 $em_columns = array(
 
  "epuesto"  =>array("header"=>"Puesto en Español",  "type"=>"textbox",  "width"=>"260px", "req_type"=>"rt", "title"=>"Turno"),
  "ipuesto"  =>array("header"=>"Puesto en Ingles",  "type"=>"textbox",  "width"=>"260px", "req_type"=>"rt", "title"=>"Turno"),
  "area"  =>array("header"=>"Área",  "type"=>"textbox",  "width"=>"160px", "req_type"=>"rt", "title"=>"Turno"),
