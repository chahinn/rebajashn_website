...
##  *** put a primary key on the first place 
  $sql ="SELECT  phpap105_menu.name ,phpap105_adicionales.id, phpap105_adicionales.id_app ,phpap105_adicionales.id_member,phpap105_adicionales.derechos  
FROM  phpap105_adicionales ,  phpap105_menu 
WHERE  phpap105_menu.id =  phpap105_adicionales.id_app and phpap105_adicionales.id_member= ".intval($mgid);   
...
##  *** set DataGrid caption
 ...
 <div id='headerhome' >
	  ...
	  <ul id='service'>
		<li><a href='usuarios.php'>Opciones Adicionales</a></li>
	  </ul>
 </div>
  <br/>
  <div id='breadcrumb'>
...
##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
 $vm_colimns = array(
    "name" =>array("header"=>"Nombre de la APP", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
      "derechos" =>array("header"=>"Derechos para la APP", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
...
##  ***  set settings for add/edit/details modes
  $table_name  = _DB_PREFIX."adicionales";
  $primary_key = "id";
...
##  *** make sure your WYSIWYG dir has 777 permissions
 ...
 $em_columns = array(
  ...
  "id_app"  =>array("header"=>"App",  "type"=>"textbox",  "width"=>"160px", "req_type"=>"ri", "title"=>"App"),
  "id_member" =>array("header"=>"", "type"=>"hidden",   "req_type"=>"st", "default"=>intval($mgid), "unique"=>false),
  
  "derechos" =>array("header"=>"Charger Types", "type"=>"enum",  "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "source"=>$fill_from_array_chargers, "view_type"=>"checkbox", "radiobuttons_alignment"=>"horizontal|vertical", "multiple"=>true, "multiple_size"=>"5"),
...
/* "derechos"  =>array("header"=>"Subscribe for news?", "type"=>"checkbox",   "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "true_value"=>1, "false_value"=>0), */
 ...
 $dgrid->setColumnsInEditMode($em_columns);
   ...
   $foreign_keys = array(
    "id_app"=>array("table"=>"phpap105_menu", "field_key"=>"id", "field_name"=>"name", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"is_menu_group=0", "order_by_field"=>"", "order_type"=>"ASC", "on_js_event"=>""),
	 ); 
