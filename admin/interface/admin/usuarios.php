...
##  *** put a primary key on the first place 
  $sql=" SELECT *   ,  'App Adicionales' AS menu_adicionales_link,'mensajes' AS mensajes_link from  members";
...
##  *** set DataGrid caption
 ...
 <div id='headerhome' >
	  ...
	  <ul id='service'>
		<li><a href='usuarios.php'>Control de Usuarios</a></li>
	  </ul>
 </div>
  <br/>
  <div id='breadcrumb'>
...
$fill_from_array = array("0"=>"No", "1"=>"Yes");  /* as "value"=>"option" */
 $filtering_fields = array(
     "login"=>array("table"=>"members", "field"=>"login", "source"=>"self", "show_operator"=>false, "default_operator"=>"like%", "order"=>"ASC", "type"=>"textbox", "case_sensitive"=>false, "comparison_type"=>"string"),
	  "nombres"=>array("table"=>"members", "field"=>"firstname", "source"=>"self", "show_operator"=>false, "default_operator"=>"like%", "order"=>"ASC", "type"=>"textbox", "case_sensitive"=>false, "comparison_type"=>"string"),
	   "apellidos"=>array("table"=>"members", "field"=>"lastname", "source"=>"self", "show_operator"=>false, "default_operator"=>"like%", "order"=>"ASC", "type"=>"textbox", "case_sensitive"=>false, "comparison_type"=>"string"),
...
##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
 $vm_colimns = array(
   "login"=>array("header"=>"Usuario","type"=>"label",  "align"=>"left", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
   "firstname"=>array("header"=>"Nombres","type"=>"label",  "align"=>"left",  "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
   "lastname" =>array("header"=>"Apellidos","type"=>"label",  "align"=>"left",  "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
   "turno" =>array("header"=>"Turno","type"=>"label","width"=>"40px",  "align"=>"left",  "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
   "pic"      => array("header"=>"Foto", "type"=>"image",  "align"=>"center",  "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>"false", "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower|camel", "summarize"=>"false", "sort_type"=>"string|numeric", "sort_by"=>"", "visible"=>"true", "on_js_event"=>"", "target_path"=>"../uploads/", "default"=>"default_image.ext", "image_width"=>"70px", "image_height"=>"60px", "magnify"=>"true", "magnify_type"=>"magnifier", "magnify_power"=>"1"),
   
    "menu_adicionales_link" =>array("header"=>" ", "type"=>"link",       "align"=>"center", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>"", "field_key"=>"member_id", "field_data"=>"menu_adicionales_link", "rel"=>"", "title"=>"Opciones Adicionales", "target"=>"", "href"=>"menu_options_adicionales.php?mgid={0}"),

    "mensajes_link" =>array("header"=>" ", "type"=>"link",       "align"=>"center", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>"", "field_key"=>"member_id", "field_data"=>"mensajes_link", "rel"=>"", "title"=>"mensajes", "target"=>"", "href"=>"mensajes.php?mgid={0}"),
...
##  *** make sure your WYSIWYG dir has 755 permissions
 ...
 $fill_from_array = array("10000"=>"10000", "250000"=>"250000", "5000000"=>"5000000", "25000000"=>"25000000", "100000000"=>"100000000");
  $em_columns = array(
    ...
    "login"=>array("header"=>"Usuario","type"=>"textbox",  "width"=>"210px", "req_type"=>"rl", "title"=>"Nombre del Usuario","unique"=>true),
    "firstname"=>array("header"=>"Nombres","type"=>"textbox",  "width"=>"210px", "req_type"=>"ry", "title"=>"Nombres"),
	"lastname"=>array("header"=>"Apellidos","type"=>"textbox",  "width"=>"210px", "req_type"=>"ry", "title"=>"Apellidos"),
	"password"=>array("header"=>"Clave ","type"=>"textbox",  "width"=>"210px", "req_type"=>"rp", "title"=>"Clave de Acceso"),
	"email"=>array("header"=>"Correo","type"=>"textbox",  "width"=>"210px", "req_type"=>"se", "title"=>"Correo Electronico"),
	"puesto"  =>array("header"=>"Puesto", "type"=>"textbox",  "width"=>"160px", "req_type"=>"si", "title"=>"Puesto",),
	"area"=>array("header"=>"Area","type"=>"textbox",  "width"=>"180px", "req_type"=>"rt", "title"=>"Turno del Usuario"),
	"turno"=>array("header"=>"Turno","type"=>"textbox",  "width"=>"180px", "req_type"=>"rt", "title"=>"Turno del Usuario"),
	 "rota" =>array("header"=>"Turno Rotativos", "type"=>"enum","req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>false, "maxlength"=>"-1", 	"default"=>"no", "unique"=>false, "unique_condition"=>"", "on_js_event"=>"", "source"=>"self", "view_type"=>"dropdownlist"),
	"type" =>array("header"=>"Tipo", "type"=>"enum","req_type"=>"st", "width"=>"210px", "title"=>"Tipo de Usuario", "readonly"=>false, "maxlength"=>"-1",	 	"default"=>"", "unique"=>false, "unique_condition"=>"", "on_js_event"=>"", "source"=>"self", "view_type"=>"dropdownlist"),
 	"grupo"  =>array("header"=>"Grupo de App",    "type"=>"textbox",  "width"=>"160px", "req_type"=>"ri", "title"=>"Grupo",),
	"obs"=>array("header"=>"Perfil","type"=>"textarea", "width"=>"210px", "req_type"=>"st", "title"=>"Breve Perfil", 
					"edit_type"=>"wysiwyg", "rows"=>"7", "cols"=>"50"),
	
 	"pic"=>array("header"=>"Fotografia","type"=>"image","req_type"=>"st", "width"=>"210px", "title"=>"Foto del usuario", "readonly"=>false, 
				 "maxlength"=>"-1", "default"=>"", "unique"=>false, "unique_condition"=>"", "on_js_event"=>"", "target_path"=>"../uploads/", 
				 "max_file_size"=>"500K", "image_width"=>"100px", "image_height"=>"100px", "file_name"=>"", "host"=>"local"),	
  ...
  $dgrid->setColumnsInEditMode($em_columns);
	...
	"turno"=>array("table"=>"members_turno", "field_key"=>"id", "field_name"=>"turno", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"", "order_by_field"=>"id", "order_type"=>"ASC", "on_js_event"=>""),
	"puesto"=>array("table"=>"members_puesto", "field_key"=>"id", "field_name"=>"epuesto", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"", "order_by_field"=>"id", "order_type"=>"ASC", "on_js_event"=>""),
    "area"=>array("table"=>"members_area", "field_key"=>"id_area", "field_name"=>"nom_area", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"", "order_by_field"=>"", "order_type"=>"ASC", "on_js_event"=>""),
