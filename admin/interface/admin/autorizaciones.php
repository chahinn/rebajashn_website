...
##  *** put a primary key on the first place 
  $sql ="SELECT * from members, members_area,members_autorizaciones where members.member_id=members_autorizaciones.user_id and members_area.id_area=members_autorizaciones.area_id ";
...
##  *** set DataGrid caption
 ...
 <div id='headerhome' >
  ...
  <br/>
  <div id='breadcrumb'>
       <a class='home' href='autorizaciones.php'>Inicio</a>
  </div>
    ";
...
##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
 $vm_colimns = array(
    "login" =>array("header"=>"Usuario", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
    "firstname" =>array("header"=>"Nombres", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
    "lastname" =>array("header"=>"Apellidos", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),

    "nom_area" =>array("header"=>"Autorizado", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
...
##  ***  set settings for add/edit/details modes
  $table_name  ="members_autorizaciones";
  $primary_key = "id_autoriza";
...
##  *** make sure your WYSIWYG dir has 777 permissions
 ...
 $em_columns = array(
  ...
  "user_id"  =>array("header"=>"Usuario",  "type"=>"textbox",  "width"=>"160px", "req_type"=>"rt", "title"=>"Turno"),
   "area_id"  =>array("header"=>"Area", "type"=>"date",   "req_type"=>"rt", "width"=>"187px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1",  "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "calendar_type"=>"dropdownlist"),
...
/* "derechos"  =>array("header"=>"Subscribe for news?", "type"=>"checkbox",   "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "true_value"=>1, "false_value"=>0), */
 ...
 $foreign_keys = array(
	...
	"user_id"=>array("table"=>"members", "field_key"=>"member_id", "field_name"=>"login", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"", "order_by_field"=>"login", "order_type"=>"ASC", "on_js_event"=>""),
	"area_id"=>array("table"=>"members_area", "field_key"=>"id_area", "field_name"=>"nom_area", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"", "order_by_field"=>"id_area", "order_type"=>"ASC", "on_js_event"=>""),
