...
##  *** set DataGrid caption
 ...
 <div id='headerhome' >
	  ...
	  <ul id='service'>
		<li><a href='areas.php'>Control de Puestos</a></li>
	  </ul>
 </div>
  <br/>
  <div id='breadcrumb'>
       <a class='home' href='areas.php'>Inicio</a>
  </div>
    ";
...
##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
 $vm_colimns = array(
    "nom_area" =>array("header"=>"Area", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
 );
...
##  *** make sure your WYSIWYG dir has 777 permissions
 ...
 $em_columns = array(
    ...
    "nom_area"  =>array("header"=>"Área",  "type"=>"textbox",  "width"=>"160px", "req_type"=>"rt", "title"=>"Turno"),
