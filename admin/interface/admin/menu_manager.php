...
##  *** set DataGrid caption
 ...
 <div id='headerhome' >
	  ...
	  <ul id='service'>
		<li><a href='menu_manager.php'>Control de Aplicaciones </a></li>
	  </ul>
 </div>
  <br/>
  <div id='breadcrumb'>
...
##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
 $vm_colimns = array(
    "name"              =>array("header"=>"Grupo Menu", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
...
##  *** make sure your WYSIWYG dir has 777 permissions
 ...
 $em_columns = array(
    ...
    "name"              =>array("header"=>"Nombre del Grupo de menu", "type"=>"textbox",   "req_type"=>"ry", "width"=>"210px", "title"=>"Menu Group Name", "readonly"=>false, "maxlength"=>"-1", "default"=>"", "unique"=>false, "unique_condition"=>"", "visible"=>"true", "on_js_event"=>""),
    ...
    "order_index"       =>array("header"=>"Orden", "type"=>"textbox",   "req_type"=>"ri", "width"=>"210px", "title"=>"Order Index", "readonly"=>false, "maxlength"=>"-1", "default"=>"0", "unique"=>false, "unique_condition"=>"", "visible"=>"true", "on_js_event"=>""),
    "is_hidden"         =>array("header"=>"Escondido?",  "type"=>"enum",      "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>false, "maxlength"=>"-1", "default"=>"0", "unique"=>false, "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "source"=>$fill_from_array_hidden, "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "multiple"=>false, "multiple_size"=>"4"),
