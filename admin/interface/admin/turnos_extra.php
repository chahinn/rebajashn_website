...
##  *** put a primary key on the first place 
  $sql ="SELECT * from members_turno_extra";
...
##  *** set DataGrid caption
 ...
 <div id='headerhome' >
	  ...
	  <ul id='service'>
		<li><a href='turnos_extra.php'>Control de Turnos Extra</a></li>
	  </ul>
 </div>
  <br/>
  <div id='breadcrumb'>
       <a class='home' href='turnos_extra.php'>Inicio</a>
  </div>
    ";
...
##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
 $vm_colimns = array(
    "idusuario" =>array("header"=>"Usuario", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
  
    "fecha_apr" =>array("header"=>"Día autorizado", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),

  "idautoriza" =>array("header"=>"Autorizado por", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false,  "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
 );
...
##  ***  set settings for add/edit/details modes
  $table_name  ="members_turno_extra";
  $primary_key = "id";
...
##  *** make sure your WYSIWYG dir has 777 permissions
 ...
 $em_columns = array(
  ...
  "idusuario"  =>array("header"=>"Usuario",  "type"=>"textbox",  "width"=>"160px", "req_type"=>"rt", "title"=>"Turno"),
   "fecha_apr"  =>array("header"=>"fecha", "type"=>"date",   "req_type"=>"rt", "width"=>"187px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1",  "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "calendar_type"=>"dropdownlist"),
 "horas"  =>array("header"=>"Horas autorizadas",  "type"=>"textbox",  "width"=>"160px", "req_type"=>"rf", "title"=>"horas"),
"idautoriza"  =>array("header"=>"Autorizado por:", "type"=>"textbox",   "req_type"=>"rt", "width"=>"187px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "calendar_type"=>"dropdownlist"),
...
/* "derechos"  =>array("header"=>"Subscribe for news?", "type"=>"checkbox",   "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "true_value"=>1, "false_value"=>0), */
 ...
 $foreign_keys = array(
	...
	"idusuario"=>array("table"=>"members", "field_key"=>"member_id", "field_name"=>"login", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"", "order_by_field"=>"login", "order_type"=>"ASC", "on_js_event"=>""),
	"idautoriza"=>array("table"=>"members", "field_key"=>"member_id", "field_name"=>"login", "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "condition"=>"", "order_by_field"=>"login", "order_type"=>"ASC", "on_js_event"=>""),
