...
<?php
		...
		##  *** set data source with needed options
		  $default_order_field = "id_categoria";
...
*/		##  *** set CSS class for datagrid
 ...
 <div id='headerhome' >
	  ...
	  <ul id='service'>
		<li><a href='el_categorias_crud.php'>Control de Categorias </a></li>
	  </ul>
 </div>
  <br/>
  <div id='breadcrumb'>
       <a class='home' href='el_categorias_crud.php'>Inicio</a>
 ...
 $dgrid->setCaption($dg_caption);
		...
		/// $fill_from_array = array("0"=>"Banned", "1"=>"Active", "2"=>"Closed", "3"=>"Removed"); /* as "value"=>"option" */
		  $vm_colimns = array(
		    "categoria"=>array("header"=>"Categoría", "type"=>"label", "align"=>"left", "width"=>"X%|Xpx", "wrap"=>"wrap|nowrap", "text_length"=>"-1", "tooltip"=>"false", "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower|camel", "summarize"=>"false", "sort_type"=>"string|numeric", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
            "mostrarpopup" =>array("header"=>"Popup", "type"=>"label", "align"=>"left", "width"=>"X%|Xpx", "wrap"=>"wrap|nowrap", "text_length"=>"-1", "tooltip"=>"false", "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower|camel", "summarize"=>"false", "sort_type"=>"string|numeric", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
		...
		$em_columns = array(
		     "categoria"        =>array("header"=>"Categoría", "type"=>"textbox", "req_type"=>"rt", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>""),
		     "mostrarpopup" =>array("header"=>"Mostar en popup", "type"=>"enum","req_type"=>"rt", "width"=>"210px", "title"=>"", "readonly"=>false, "maxlength"=>"-1", 	"default"=>"no", "unique"=>false, "unique_condition"=>"", "on_js_event"=>"", "source"=>"self", "view_type"=>"dropdownlist"),				 
