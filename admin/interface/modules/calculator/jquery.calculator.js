...
function Calculator() {
	...
	this.regional[''] = { // Default regional settings
		...
		closeStatus: 'Cerrar la calculadora', // Status text for close link
		useText: 'Usar', // Display text for use link
		useStatus: 'Usar el valor', // Status text for use link
		eraseText: 'Borrar', // Display text for erase link
		eraseStatus: 'Borrar lo datos del Campo', // Status text for erase link
