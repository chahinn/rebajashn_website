...
//obtener la oferta del dia
	 ...
	 //$sql_cupon="SELECT * FROM el_cupones where (ciudad=$ciudad or ciudad1=$ciudad or ciudad2=$ciudad) and ofertadeldia='si' and (NOW()>=ofertadiadesde and NOW()<=ofertadiahasta) and esevento='si'";
    $sql_cupon="SELECT * FROM el_cupones where ofertadeldia='si' and (NOW()>=ofertadiadesde and NOW()<=ofertadiahasta) and esevento='si'";	
	//echo $sql_cupon;
	 //$oferta =  $db->query_first($sql_cupon);
...
<table class="table table-bordered"  >
   	<thead>
		<tr style="background-color:#f5f5f5;"> <th><span style="margin-right:10px;font-size:18px" class="label label-success">El evento del d&iacute;a</span></th></tr>
	</thead>
	<tbody>			    	
				...
				<div class="span6">
				   <h2> <?php echo $oferta['titulo'];?> - <?php	 $nombre_ciudad=buscar_ciudad($ciudad,$db); echo $nombre_ciudad;?> </h2>
					...
					<p><?php echo $oferta['descripcion'];?></p>	
					  ...
					  <a title="" class="jSideDeal" href="elevation19_evento.php?visto=1&id=<?php echo $oferta['id'];?>">
					<button class="btn btn-large btn-success" href="#"><strong>Ver evento</strong></button>
					</a>
					<hr>
				</div>
     ...
     <div class="navbar box">						
			...
			<ul class="nav pull-right">
				<li><div id="filter">
									<p>
									 ...
									 <input class="description" name="query" id="faq_search_input"  type="text" value="" placeholder="Buscar Evento" style="margin-left: 20px;"/>
									 </p>
		...
		<div id="listados">		
			...
			//crear el sql del listado
			  $sql_ofertas = "SELECT * FROM el_cupones where activo='1' and (NOW()>=desde and NOW()<=hasta) and esevento='si'  ORDER BY id DESC";
			  //echo $sql_ofertas;
			...
			<li class="book first odd gridview-item gridview-item-first gridview-row-first" data-type="app">  
				...
				<div id="project-cover-4504321" class="project-cover cfix hover" project_id="4504321" style="border-top-left-radius:10px;border-top-right-radius:12px;">
					...
					<div class="contenthover">
						...
						<p><a class="btn btn-success" href="elevation19_evento.php?visto=1&id=<?php echo $record_ofertas['id'];?>">Ver Evento</a></p>
					</div>
				  </div>
					...
					<div class="cover-stat-wrap">
						...
						<span class="stat-label be-font-inline"><i class="icon-download-alt"></i> Asistir&aacute;n</span>
