...
border-style: dashed;">
  <tr>
    <td width="241" rowspan="4"><img src="../assets/img/center.gif" width="241" height="105" /></td>
    
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td width="374" align="left"><em><strong>C&oacute;digo del cup&oacute;n</strong></em></td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
    <td width="374" rowspan="2" align="center" valign="middle" style="font-size: 46px"> <strong><?php $cod=buscar_codigo($oferta['id'],$db); echo $cod;?></strong></td>
  </tr>
  <tr>
    <td height="34">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td colspan="3" style="font-size: 36px"><b> <?php echo $oferta['titulo'];?></b></td>
  </tr>
  <tr>
    <td colspan="2"  style="font-size: 24px"><em><?php echo $row_emp['empresa'];?> - <?php  $nombre_ciudad=buscar_ciudad($ciudad,$db);echo $nombre_ciudad?></em></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="31"><strong>Acreditado a:</strong></td>
    <td colspan="2" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Pasos para Canjear el Cup&oacute;n:</strong></td>
  </tr>
  <tr>
    <td colspan="2" valign="top" style="font-size: 24px"><?php echo $_SESSION['SESS_NOMBRES'].' '.$_SESSION['SESS_APELLIDOS'];?></td>
    <td rowspan="3"  style="font-size: 14px"><ol>
  ...
  <tr>
    <td height="21" valign="top"><strong>Fecha de vencimiento:</strong></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="center" valign="top"><?php echo $oferta['hasta'];?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
