...
<html lang="es">
  ...
  <head>
  <meta property="og:title" content="elevation19" />
<meta property="og:type" content="" />
<meta property="og:url" content="http://www.elevation19.com" />
<meta property="og:image" content="" />
<meta property="og:site_name" content="elevation19" />
<meta property="fb:admins" content="1138244815" />
  <?php
// session_start();
 ...
 if ($ciudad=="" && $cupon=="")
   {
	 ...
	 $sql_cupon="SELECT * FROM el_cupones  where id='$oferta_id'";
	 //echo $sql_cupon;
		...
		<table class="table table-bordered">
			    	<thead>
			    		<tr style="background-color:#f5f5f5;">
			    			<th><span style="margin-right:10px;font-size:14px" class="label label-success"> &Uacute;ltimas Cupones</span></th>
			    		</tr>
			    	</thead>
			    	<tbody>			    	
					...
					<?php
					  ...
					  $sql_ultimas = "SELECT * FROM el_cupones where activo='1' and ofertadeldia<>'si' and esevento='no'  ORDER BY id DESC  LIMIT 0,3";
					  //echo $sql_ultimas;
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
   ...
   <?php $url="http://elevation19.com/members/elevation19_oferta.php?visto=1&id=".$oferta_id;?>
