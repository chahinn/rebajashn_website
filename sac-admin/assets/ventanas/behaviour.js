 ...
 */
(function($){
var winJQ,lastMouseX,lastMouseY,zIndex=100000,minH,minW=160,newWinOffset=50,
isIE=navigator.userAgent.match(/MSIE/),
template='<div class=window><div class=windowtitlebar><img src=/favicon.ico width=16 height=16 class=titlebaricon><div class=titlebartext></div><div class=horizbuts><div class=minimizebut title=minimizar></div><div class=restorebut title=restaurar></div><div class=maximizebut title=maximizar></div><div class=closebut title=cerrar></div></div></div><div class=windowcontent></div><div class=resizer-tl></div><div class=resizer-t></div><div class=resizer-tr></div><div class=resizer-r></div><div class=resizer-br></div><div class=resizer-b></div><div class=resizer-bl></div><div class=resizer-l></div></div>',
resizerP=$('<div id=resizerproxy>')
...
resizerPos,resizeMask, // top=1,right=2,bottom=4,left=8
...
moverPos.width = winJQ.width();
moverPos.height = winJQ.height();
...
onClickCloseBut =
	function(){$(this).closest('.window').WM_close();return false;},
...
if (e.button==0&&this.target.match(/^\_child\b/)) {
	var t = $(this);
